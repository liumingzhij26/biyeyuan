...
<title>PHP探针-UPUPW环境集成包NGINX专用版</title>
...
<meta name="description" content="UPUPW环境集成包NGINX专用版PHP探针可检测ZendGuardLoader,ionCube,memcache,XCache,WinCache和SendMail等PHP组件." />
...
<table class="info tablex1">
  ...
  <tr>
    ...
    <td class="fl">
    <a target="_blank" href='<?=_SERVER('PHP_SELF')?>?act=phpinfo'>PHP详细信息</a> | <a target="_blank" href="/phpmyadmin/">MySQL管理</a>
    </td>
  </tr>
</table>
...
<?}?>
 ...
 <p style="color:#505050; font-size:14px; text-align:center;">&copy;2003-2014 <a href="http://www.upupw.net">WWW.UPUPW.NET</a> 版权所有</p>
</div>
</body>
</html>
