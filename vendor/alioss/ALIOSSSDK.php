...
use AliOSS\util\MimeTypes;
use \SimpleXMLElement;
use \SimpleXmlIterator;
use \Exception;
use AliOSS\util\OSS_Exception;
use AliOSS\util\OSSUtil;
use AliOSS\lib\requestcore\RequestCore;
use AliOSS\lib\requestcore\ResponseCore;
use AliOSS\lib\requestcore\RequestCore_Exception;
...
class ALIOSSSDK
{
     ...
     * @return ResponseCore
     */
    public function listBucket($options = NULL)
    {
     ...
     * @return ResponseCore
     */
    public function setBucketAcl($bucket, $acl, $options = NULL)
    {
        $this->precheck_common($bucket, NULL, $options, false);
        $options[self::OSS_BUCKET] = $bucket;
        $options[self::OSS_METHOD] = self::OSS_HTTP_PUT;
     ...
     * @return ResponseCore
     */
    public function setBucketLogging($bucket, $target_bucket, $target_prefix, $options = NULL)
    {
        $this->precheck_common($bucket, NULL, $options, false);
     ...
     * @return ResponseCore
     */
    public function listObject($bucket, $options = NULL)
    {
        $this->precheck_common($bucket, NULL, $options, false);
        $options[self::OSS_BUCKET] = $bucket;
        $options[self::OSS_METHOD] = self::OSS_HTTP_GET;
     ...
     * @return void
     */
    public function setEnableDomainStyle($enable_domain_style = true)
    {
