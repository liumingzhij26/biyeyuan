<?php
namespace AliOSS\util;

// EXCEPTIONS
use alioss\lib\ResponseCore;
use alioss\thirdparty\XML2Array;
...
class OSSUtil
{
     ...
     * @param string $format
     * @return ResponseCore|array
     * @throws \AliOSS\thirdparty\Exception
     */
    public static function parse_response(ResponseCore $response, $format="array"){
