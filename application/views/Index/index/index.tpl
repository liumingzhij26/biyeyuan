        ...
        <section class="container">
            ...
            <p class="h4">
                <a href="http://lmzj26.blog.51cto.com/" style="padding:17px 0;" target="_blank" class="bootstro"
                   data-bootstro-placement="bottom" data-bootstro-step="4"><span class="btn btn-warning">个人博客</span></a>
                <a href="http://pan.baidu.com/share/link?shareid=2546548621&uk=3607515896"
                   class="hidden-phone hidden-tablet" target="_blank" alt="本站源码下载"><span
                            class="btn btn-success ">本站源码</span></a></p>
            ...
            <p class="h5"><span class="bootstro"
                                data-bootstro-title="不再支持IE6/7等浏览器；推荐升级到：IE9+、Chrome、Firefox、Opera和Safari等现代浏览器。"
    ...
    <section class="container">
        <article class="content">
            ...
            <table class="table table-striped">
                <tr>
                    <td width="5%">1、</td>
                    <td width="95%"><p>熟练应用PHP、MYSQL技术，熟悉LNAMP、Mac、VirtualBox
                            vagrant环境开发，linux常用命令与服务器搭建，LVS.Dr,Squid代理，nginx负载均衡，了解TCP/IP、HTTP/HTTPS原理，有大型电商开发经验(单日千万级PV)等。（有网工认证，在学校考的）</p>
                    </td>
                </tr>
                <tr>
                    <td>2、</td>
                    <td><p>有WEB安全开发经验，熟悉SQL注入，爆库，xss攻击，数据库加密等技术，有白帽子经验。 （曾2012年获得网络安全全国二等奖）</p></td>
                </tr>
                <tr>
                    <td>3、</td>
                    <td><p>熟练MYSQL、MSSQL数据库、Redis，可独立完成库表结构设计和SQL语句优化编写、主从复制，有百万级以上数据库处理经验,对innodb有深入的学习等 </p></td>
                </tr>
                <tr>
                    <td>4、</td>
                    <td><p>b/s结构WEB系统开发，Bootstrap，Javascript、AJAX、JQuery与JQuery插件开发。</p></td>
                </tr>
                <tr>
                    <td>5、</td>
                    <td><p>
                ...
                <tr>
                    <td>7、</td>
                    <td><p>API开发经验，如谷歌地图、百度地图、支付宝接口、(腾讯|新浪)微博，OAuth2.0等。 </p></td>
                </tr>
                <tr>
                    <td>8、</td>
                    <td><p>有专业的SEO经验，对网站页面结构、URL优化（对正则有高要求）、TDK配置非常了解。（为多家大型企业提供过SEO技术支持，如国航、阳光保险、太平保险、走秀网等）</p></td>
                </tr>
                <tr>
                    <td>9、</td>
                ...
                <tr>
                    <td>11、</td>
                    <td><p>如果您能邀请我面试，我会回答上面所有技术问题（可以提供本人项目源码，不提供企业项目源码）</p></td>
                </tr>
            </table>
        </article>
        <article class="content">
            ...
            <ul class="thumbnails">
                ...
                <li class="span4">
                    <section class="thumbnail">
                        ...
                        <p class="text-left">通过struts2框架控制action，调用用友U8的数据接口，使用jquery、ajax,...</p>
        ...
        <article class="content">
            ...
            <table class="table table-striped table-hover">
                <tr>
                    <td>看书、买书（专业、武侠、魔幻）</td>
                    <td>买电子储存产品（见过有人用3.5寸的移动硬盘吗）</td>
                </tr>
                <tr>
                    <td>看电影，大片必看（最喜欢魔戒系列）</td>
                    <td>玩三国杀、英雄杀（现在游戏只玩英雄杀）</td>
                </tr>
                <tr>
                    <td>睡觉睡到自然醒</td>
                    <td></td>
